...
ActiveRecord::Schema.define(version: 2021_04_04_003424) do
  ...
  create_table "product_backlogs", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "sprint_backlogs", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
